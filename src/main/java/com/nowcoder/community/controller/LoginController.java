...
//        session.setAttribute(CommunityConstant.KAPTCHA, text);
        // 验证码的归属//TODO 缓存验证码
...
//        String kaptcha = (String) session.getAttribute(CommunityConstant.KAPTCHA);
        ...
        if(map.containsKey(CommunityConstant.TICKET)){
            Cookie cookie = new Cookie(CommunityConstant.TICKET,map.get(CommunityConstant.TICKET).toString());
            cookie.setPath(contextPath);
